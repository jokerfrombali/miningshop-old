...
$(document).ready(function () {
    $(".text-danger").each(function () {
        ...
        $("#content .product-grid > .clearfix").remove(), $("#content .row > .product-grid").attr("class", "popular category-item"), $("#grid-view").removeClass("active"), $("#list-view").addClass("active"), localStorage.setItem("display", "list")
    }), $("#grid-view").click(function () {
        $("#column-right, #column-left").length;
        $("#content .product-list").attr("class", "popular category-item"), $("#list-view").removeClass("active"), $("#grid-view").addClass("active"), localStorage.setItem("display", "grid")
    ...
    }), $("[data-toggle='tooltip']").tooltip({container: "body", trigger: "hover"}), $(document).ajaxStop(function () {
        $("[data-toggle='tooltip']").tooltip({container: "body"})
    }), cols = $("#column-right, #column-left").length;
    var t = $("#content .product-layout:not(.product-list,.product-grid)");
        ...
        $.ajax({
            ...
            success: function (t) {
                $(".alert, .text-danger").remove(), t.redirect && (location = t.redirect), t.success && ($("#content").parent().before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + t.success + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>'), setTimeout(function () {
                    $("#cart > button").html('<span id="cart-total"> ' + t.total + "</span>"), $("#cart-total2").html('<span id="cart-total"><i class="fa fa-shopping-cart"></i> ' + t.total + "</span>")
